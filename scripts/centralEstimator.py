...
class localEstimator(Estimator, outTopic='obstacleList'):
    """docstring for Estimator"""

    def __init__(self,):
        # ROS INIT
        super(CentralEstimator, self).__init__()
        # get params
        self.egoName = rospy.get_namespace()
        ...
        for drone in self.manifest:
            self.poses.append(rospy.Subscriber(
